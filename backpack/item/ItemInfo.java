...
public class ItemInfo {
    ...
    public static final String[] NAME_BACKPACK = { "Black Backpack", "Red Backpack", "Green Backpack", "Brown Backpack", "Blue Backpack", "Purple Backpack", "Cyan Backpack", "Light Gray Backpack",
        "Gray Backpack", "Pink Backpack", "Lime Green Backpack", "Yellow Backpack", "Light Blue Backpack", "Magenta Backpack", "Orange Backpack", "White Backpack", "Backpack", "Ender Backpack" };
    ...
    public static final String UNLOCALIZED_NAME_BACKPACK_WORKBENCH = "backpack";
    public static final String NAME_BACKPACK_WORKBENCH = "Workbench Backpack";
    ...
    public static final String NAME_BOUND_LEATHER = "Bound Leather";
    ...
    public static final String NAME_TANNED_LEATHER = "Tanned Leather";
