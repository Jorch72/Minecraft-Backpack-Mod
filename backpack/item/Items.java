...
public class Items {
    ...
    public static void addNames() {
        ...
        itemStack = new ItemStack(backpack, 1, 16);
        LanguageRegistry.addName(itemStack, ItemInfo.NAME_BACKPACK[16]);
        itemStack = new ItemStack(backpack, 1, 48);
        LanguageRegistry.addName(itemStack, "Big " + ItemInfo.NAME_BACKPACK[16]);
        for(int i = 0; i < 16; i++) {
            ...
            LanguageRegistry.addName(itemStack, "Big " + ItemInfo.NAME_BACKPACK[i]);
        }
        itemStack = new ItemStack(backpack, 1, ItemInfo.ENDERBACKPACK);
        LanguageRegistry.addName(itemStack, ItemInfo.NAME_BACKPACK[17]);
