...
public class Constants {
	...
	public static final String[] BACKPACK_NAMES = { "Black Backpack",
			"Red Backpack", "Green Backpack", "Brown Backpack",
			"Blue Backpack", "Purple Backpack", "Cyan Backpack",
			"Light Gray Backpack", "Gray Backpack", "Pink Backpack",
			"Lime Green Backpack", "Yellow Backpack", "Light Blue Backpack",
			"Magenta Backpack", "Orange Backpack", "White Backpack",
			"Backpack", "Ender Backpack", "Workbench Backpack" };
	public static final String[] BACKPACK_COLORS = { "black", "red", "green",
			"brown", "blue", "purple", "cyan", "lightGray", "gray", "pink",
